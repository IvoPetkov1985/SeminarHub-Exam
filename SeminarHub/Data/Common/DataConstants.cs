namespace SeminarHub.Data.Common
{
    public static class DataConstants
    {
        ...
        public const string TopicRequiredErrorMsg = "The Seminar Topic field is required.";
        ...
        public const string DateTimeRequiredErrorMsg = "The Date of Seminar field is required.";
